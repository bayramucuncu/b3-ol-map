  ...
  constructor(private activatedRoute: ActivatedRoute) {
    ...
    this.map = {
      ...
      layers: [
        ...
        { "id": "58c15bd2-bc59-4a4f-9b86-ac8309728f1c", "order": 2, "type": "tile", "name": "Şehir Haritası", "isBase": true, "layerSettings": { "minResolution": "0.14", "maxResolution": "200" }, "sourceSettings": { "type": "tilewmts", "url": "https://tileservices.kocaeli.bel.tr/geoserver/gwc/service/wmts", "layer": "kbb:wm_carto_v2", "matrixSet": "EPSG:900913" } },
